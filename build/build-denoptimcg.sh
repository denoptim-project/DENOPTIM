...
javac -cp lib/cdk-1.4.19.jar:lib/gson-2.8.6.jar:lib/vecmath.jar:lib/DENOPTIM-GUI.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-1.4.19.jar lib/gson-2.8.6.jar lib/vecmath.jar lib/DENOPTIM-GUI.jar " >> manifest.mf
echo >> manifest.mf
