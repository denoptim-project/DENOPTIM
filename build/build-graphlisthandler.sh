...
javac -cp lib/cdk-1.4.19.jar:lib/DENOPTIM-GUI.jar:lib/commons-io-2.4.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-1.4.19.jar lib/DENOPTIM-GUI.jar lib/commons-io-2.4.jar" >> manifest.mf
echo >> manifest.mf
