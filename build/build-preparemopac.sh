...
javac -cp lib/cdk-2.3.jar:lib/commons-cli-1.3.1.jar:lib/DENOPTIM-GUI.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-2.3.jar lib/commons-cli-1.3.1.jar lib/DENOPTIM-GUI.jar" >> manifest.mf
echo >> manifest.mf
