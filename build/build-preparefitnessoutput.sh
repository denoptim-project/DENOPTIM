...
javac -cp lib/cdk-2.3.jar:lib/jgrapht-core-1.4.0.jar:lib/commons-cli-1.3.1.jar:lib/DENOPTIM-GUI.jar:lib/gson-2.8.6.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-2.3.jar lib/jgrapht-core-1.4.0.jar lib/commons-cli-1.3.1.jar lib/DENOPTIM-GUI.jar lib/gson-2.8.6.jar" >> manifest.mf
echo >> manifest.mf
