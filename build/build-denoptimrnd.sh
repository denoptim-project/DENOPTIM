...
javac -cp lib/cdk-2.3.jar:lib/commons-io-2.4.jar:lib/commons-lang3-3.1.jar:lib/vecmath.jar:lib/commons-math3-3.6.1.jar:lib/DENOPTIM-GUI.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-2.3.jar lib/commons-io-2.4.jar lib/commons-lang3-3.1.jar lib/vecmath.jar lib/commons-math3-3.6.1.jar lib/DENOPTIM-GUI.jar" >> manifest.mf
echo >> manifest.mf
