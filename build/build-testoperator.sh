...
javac -cp lib/cdk-2.3.jar:lib/DENOPTIM-GUI.jar:DenoptimGA.jar @javafiles.txt -encoding utf-8 -d .
...
echo "Class-Path: lib/cdk-2.3.jar lib/vecmath.jar lib/DENOPTIM-GUI.jar DenoptimGA.jar" >> manifest.mf
echo >> manifest.mf
