...
public class StringConverterParameters
{
    /**
    ...
    public static void readParameterFile(String infile) throws DENOPTIMException
    {
        ...
        try
        {
            ...
            while ((line = br.readLine()) != null)
            {
                ...
                if (line.toUpperCase().startsWith("STRINGCONVERTER-"))
                {
                                                      ...
                                                      throws DENOPTIMException
    {
        ...
        switch (key.toUpperCase())
        {
            ...
            case "STRINGCONVERTER-INPUTFILE=":
                inpFile = value;
                break;
            case "STRINGCONVERTER-OUTPUTFILE=":
                outFile = value;
                break;
            case "STRINGCONVERTER-INPUTFORMAT=":
                inpFormat = StringFormat.valueOf(value.toUpperCase());
                break;
            case "STRINGCONVERTER-OUTPUTFORMAT=":
                outFormat = StringFormat.valueOf(value.toUpperCase());
                break;
            default:
