package utils;
// Package adapted for the integration in DENOPTIM
 ...
 * CDK-1.5.5 contains signs that problems related to time limitation of
 * AllRingFinder are somehow solved/bypassed, so this class may become obsolete
 * when a newer version of CDK is used (currently cdk-1.4.19 is used).
 *
...
//MF
//
// To increase the capabilities of dealing with complex topologies of
// organometallic compoundthe time limit is extended and the max size
// of the rings reduced
//
