...
public class FSParametersForm extends ParametersForm
{
    ...
    public FSParametersForm(Dimension d)
    {
        ...
        rdbSrcOrNew = new JRadioButton("Take parameters from existing fragment space:");
        ...
        String toolTipFSSource = "<html>Pathname of the file defining the fragment space.<br>This file can be generated by the DENOPTIM's GUI.<br>See construction of a new fragment space.</html>";
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                //TODO: load data into current form
                GUIWorkPanel.getNonImplementedError();
           }
        });
