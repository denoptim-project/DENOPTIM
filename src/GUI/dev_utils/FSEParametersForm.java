...
public class FSEParametersForm extends ParametersForm
{
    ...
    public FSEParametersForm(Dimension d)
    {
        ...
        String toolTipPar2 = "<html>Specifies the maximum number of layers of fragments to consider.<br>Note that the root (i.e., scaffold or root graph) is assigned <code>level = -1</code>.<br>Therefore, if this parameter is 3, we'll try to append <br>up to 4 layers of fragments (levels = 0, 1, 2, and 3).</html>";
        linePar2 = new JPanel(new FlowLayout(FlowLayout.LEFT));
        lblPar2 = new JLabel("Explore up to level numer:", SwingConstants.LEFT);
        ...
        mapKeyFieldToValueField.put(keyPar10,cmbPar10);
        ...
        mapKeyFieldToValueField.put(keyPar4,txtPar4);
        ...
        mapKeyFieldToValueField.put(keyPar11,txtPar11);
