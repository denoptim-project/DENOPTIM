...
|`GA-NumOffspringFromXover`| Specifies how many offstring (1 or 2) should result from a single crossover operation. When 2 offspring are produced, only the fittest offspring can become a member of the population.|
