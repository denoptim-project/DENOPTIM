...
|`GA-CoupleMutationToCrossover`| Requires that mutation is performed only following crossover and with a frequency controlled by the relation between mutation and crossover weights.|
